...
export default function LoginPage() {
  ...
  const nextPath = redirectPath || "/interpret";
      ...
      <div className="mx-auto w-full max-w-[480px] min-h-[100dvh] px-6 py-8 flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <div className="w-full max-w-[348px] space-y-3">
            <a
              ...
              className="w-full flex items-center justify-center gap-2 py-3 border border-gray-300 dark:border-[var(--color-border)] rounded-xl bg-white dark:bg-[var(--color-bg-secondary)] text-[#111] dark:text-[var(--color-text)] font-medium"
            >
            ...
            <Link
              to="/interpret"
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-[var(--color-primary)] bg-transparent text-[var(--color-primary)] font-medium"
            >
        ...
        <div className="pt-4 text-center space-y-2">
          <p className="text-[12px] text-[var(--color-text-secondary)]">
            <Link to="/hospital-login" className="text-[var(--color-primary)] hover:underline">
              {t("login.hospitalAdminLink")}
            </Link>
          </p>
          <p className="text-[12px] text-[var(--color-text-secondary)]">
            {t("login.termsAgree")}{" "}
