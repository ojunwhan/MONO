...
function StaffModePanel({ template, selectedDept, roomName, consultationRoomId, returnToReceptionUrl, orgCode: orgCodeProp, authChecked, selectedLang, setSelectedLang, showLangGrid, setShowLangGrid, saveMode, setSaveMode, navTo, onBack, kiosk }) {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-[var(--color-bg)] text-[var(--color-text)] overflow-x-hidden">
      ...
      <div className="flex-none py-2 text-center space-y-1">
        ...
        <button type="button" onClick={() => { window.location.href = "/hospital-dashboard"; }} className="text-[11px] text-[var(--color-text-secondary)] hover:text-[#2563EB] underline">
          Go to Dashboard
        </button>
