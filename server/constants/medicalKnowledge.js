/**
 * MONO Medical Knowledge Base — Server (CJS) version
 * 원본: src/constants/medicalKnowledge.js (ESM)
 * 
 * ⚠️ 용어 추가/수정 시 src/constants/medicalKnowledge.js도 동일하게 반영할 것
 * 
 * 구조: { ko, en, zh, ja, vi }
 * 사용법: server.js buildSystemPrompt에서 getMedicalTermContext(dept, targetLang)로 호출
 */

// ─────────────────────────────────────────────
// 1. 공통 병원 행정 / 절차
// ─────────────────────────────────────────────
const COMMON_HOSPITAL = [
...
// ─────────────────────────────────────────────
// DEPT → TERM SET MAPPING
// hospitalDepartments.js의 id값과 매핑
// ─────────────────────────────────────────────
const DEPT_TERM_MAP = {
 ...
 * @param {string} dept - 진료과 코드 (hospitalDepartments.js의 id값)
